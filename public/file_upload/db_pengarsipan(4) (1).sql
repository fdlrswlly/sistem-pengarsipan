...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Okt 2021 pada 04.57
...
INSERT INTO `surat_keluar` (`id_surat`, `no_surat`, `tgl_surat`, `perihal`, `tujuan`, `keterangan`, `file`) VALUES
(1, '2021/IV/001', '2021-09-24', 'Surat Barang Masuk', 'Logistik Barang Makanan', '', ''),
(12346, '2021/VI/005', '2021-10-07', 'Surat Edaran Covid', 'Logistik', '', ''),
(12347, '2021/V/002', '2021-10-13', 'Surat Rancangan Anggaran Biaya', 'Kadiv Produksi', '', 'RENCANA ANGGARAN BIAYA.docx');
...
INSERT INTO `surat_masuk` (`id_surat`, `no_surat`, `tgl_surat`, `perihal`, `pengirim`, `status`, `keterangan`, `file`) VALUES
(1, '2021/X/IRMA/DKM/001', '2021-10-13', 'Surat Undangan Maulid Nabi', 'Miqat Center', 'Belum Dibaca', 'Maulid Nabi', 'SURAT UNDANGAN.pdf'),
(2, '2021/III/HMTRPL/001', '2021-10-13', 'Surat Undangan Masa Bimbingan', 'HMTRPL', 'Menunggu Konfirmasi', 'Undangan menghadiri pembukaan Mabim', 'SURAT UNDANGAN.docx');
